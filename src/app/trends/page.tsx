        ...
        <div className="container mx-auto px-4 py-8 max-w-6xl animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="relative z-10 space-y-8">
                ...
                <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    ...
                    <div className="flex items-center gap-2 text-sm text-neutral-500 bg-white/50 dark:bg-black/50 backdrop-blur-md px-4 py-2 rounded-full border border-white/20">
